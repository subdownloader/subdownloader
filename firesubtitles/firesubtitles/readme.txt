...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\firesubtitles on
     Windows, /home/user/dev/firesubtitles on Linux) in a file named
     firesubtitles@ivan.garcia and copy that file to
