...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        self.label_63.setGeometry(QtCore.QRect(20,140,301,18))
        font = QtGui.QFont()
        font.setWeight(75)
        font.setBold(True)
        ...
        self.label_64.setGeometry(QtCore.QRect(31,161,122,29))
        self.label_64.setObjectName("label_64")
        self.optionVideoAppParams = QtGui.QLineEdit(self.tab_7)
        self.optionVideoAppParams.setGeometry(QtCore.QRect(112,221,278,23))
        ...
        self.optionVideoAppChooseLocation.setGeometry(QtCore.QRect(400,190,83,27))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.optionIntegrationKonqueror.sizePolicy().hasHeightForWidth())
        self.optionIntegrationKonqueror.setSizePolicy(sizePolicy)
        self.optionIntegrationKonqueror.setMinimumSize(QtCore.QSize(0,22))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.optionIntegrationGnome.sizePolicy().hasHeightForWidth())
        self.optionIntegrationGnome.setSizePolicy(sizePolicy)
        self.optionIntegrationGnome.setMinimumSize(QtCore.QSize(0,22))
        self.optionIntegrationGnome.setObjectName("optionIntegrationGnome")
        self.verticalLayout.addWidget(self.optionIntegrationGnome)
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        self.optionIntegrationExplorer.setText(QtGui.QApplication.translate("PreferencesDialog", "Enable in Windows Explorer/KDE/Gnome", None, QtGui.QApplication.UnicodeUTF8))
        self.optionIntegrationKonqueror.setText(QtGui.QApplication.translate("PreferencesDialog", "Enable in Konqueror/Dolphin", None, QtGui.QApplication.UnicodeUTF8))
        self.optionIntegrationGnome.setText(QtGui.QApplication.translate("PreferencesDialog", "Enable in Gnome", None, QtGui.QApplication.UnicodeUTF8))
