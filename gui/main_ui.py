...
#
# Created: Thu Aug 28 02:28:16 2008
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setGeometry(QtCore.QRect(0, 27, 1280, 676))
        ...
        self.tab.setGeometry(QtCore.QRect(0, 0, 1258, 626))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/imdb.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.tab_3.setGeometry(QtCore.QRect(0, 0, 1258, 626))
        ...
        self.buttonIMDBByTitle.setIcon(icon4)
        ...
        self.tab_4.setGeometry(QtCore.QRect(0, 0, 1258, 626))
        ...
        self.gridLayout.addWidget(self.uploadIMDB, 1, 2, 2, 2)
        ...
        self.gridLayout.addWidget(self.buttonUploadFindIMDB, 1, 4, 2, 1)
        ...
        self.gridLayout.addWidget(self.uploadLanguages, 4, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.uploadReleaseText, 8, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.uploadComments, 9, 2, 1, 2)
        self.label_autodetect_imdb = QtGui.QLabel(self.groupBox)
        ...
        self.label_autodetect_imdb.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.label_autodetect_lang = QtGui.QLabel(self.groupBox)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.gridLayout.addWidget(self.label_autodetect_lang, 5, 2, 1, 1)
        self.buttonUpload = QtGui.QPushButton(self.groupBox)
        ...
        self.buttonUpload.setIconSize(QtCore.QSize(16, 16))
        self.buttonUpload.setObjectName("buttonUpload")
        self.gridLayout.addWidget(self.buttonUpload, 9, 4, 1, 1)
        ...
        self.statusbar.setGeometry(QtCore.QRect(0, 703, 1280, 24))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(QtGui.QApplication.translate("MainWindow", "Select the video/folder that needs subtitles:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_2.setText(QtGui.QApplication.translate("MainWindow", "Videos/Subtitles found:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_12.setText(QtGui.QApplication.translate("MainWindow", "Subtitles found:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_2.setTitle(QtGui.QApplication.translate("MainWindow", "Select the videos and subtitles  (videos won\'t be uploaded, we just need their hash fingerprint)", None, QtGui.QApplication.UnicodeUTF8))
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:10pt; color:#ff0000;\">*</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_autodetect_imdb.setText(QtGui.QApplication.translate("MainWindow", "↓ Movie autodetected from database", None, QtGui.QApplication.UnicodeUTF8))
        self.label_autodetect_lang.setText(QtGui.QApplication.translate("MainWindow", "↑ Language autodetected from content", None, QtGui.QApplication.UnicodeUTF8))
