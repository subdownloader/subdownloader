...
class Ui_IMDBSearchDialog(object):
    ...
    def retranslateUi(self, IMDBSearchDialog):
        ...
        IMDBSearchDialog.setWindowTitle(_translate("IMDBSearchDialog", "IMDB search dialog:"))
        self.label.setText(_translate("IMDBSearchDialog", "Enter the Movie Title or IMDB id:"))
        self.searchMovieButton.setText(_translate("IMDBSearchDialog", "Search Movie"))
        self.movieInfoButton.setText(_translate("IMDBSearchDialog", "Movie Info"))
        self.okButton.setText(_translate("IMDBSearchDialog", "OK"))
        self.cancelButton.setText(_translate("IMDBSearchDialog", "Cancel"))
